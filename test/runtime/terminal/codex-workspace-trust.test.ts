...
function setupTempHome(): string {
	tempHome = mkdtempSync(join(tmpdir(), "shuvban-codex-workspace-trust-"));
...
describe("codex workspace trust helpers", () => {
	it("detects Codex trust prompt", () => {
		const codexPrompt = `
You are in /Users/saoud/.shuvban/worktrees/6df3a/mcp-swift-sdk
...
Press enter to continue`;
	...
	it("auto-confirms all codex sessions", () => {
		...
		const taskWorktreePath = join(home, ".shuvban", "worktrees", "task-123", "context");
